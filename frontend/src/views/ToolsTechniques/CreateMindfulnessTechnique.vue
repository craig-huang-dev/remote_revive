<template>
    <div class="container mt-5">
        ...
        <h2 class="text-center mb-4">Create Mindfulness Technique</h2>
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post('http://localhost:3000/api/mindfulness-techniques', payload)
                .then(response => {
